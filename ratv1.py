...
for file_name in os.listdir(r'C:\Users\esilveira\Constat\Central de Serviços - Relatórios de Fechamento\pdf_antigos'):
    print(file_name)
...
destination = r'C:\Users\esilveira\Constat\Central de Serviços - Relatórios de Fechamento\pdf_antigos\pdf_antigos'
